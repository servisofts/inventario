...
public class ModeloCliente {
    public static final String COMPONENT = "modelo_cliente";
    ...
    public static void getByKeyCliente(JSONObject obj, SSSessionAbstract session) {
        try {
            String consulta = "select get_all('" + COMPONENT + "','key_cliente', '" + obj.getString("key_cliente")
                    + "') as json";
            JSONObject data = SPGConect.ejecutarConsultaObject(consulta);
            obj.put("data", data);
            obj.put("estado", "exito");
    ...
    public static void getByKeyModelo(JSONObject obj, SSSessionAbstract session) {
        try {
